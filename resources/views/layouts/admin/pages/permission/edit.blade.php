                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input required type="text" name="name"class="form-control @error('name') is-invalid @enderror" value="{{$permission->name}}" id="name" placeholder="Enter Permission Name" >
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input required type="text" name="group_name" class="form-control @error('group_name') is-invalid @enderror" value="{{$permission->group_name}}" id="group_name" placeholder="Enter Group Name" >
