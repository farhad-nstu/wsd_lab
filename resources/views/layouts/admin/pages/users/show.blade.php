                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <div class="text-center bg-pattern">
                                            ...
                                            <h4 class="text-primary mb-2">{{ $admin->name }}</h4>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div>
                                            ...
                                            <h5 class="font-size-14">{{ $admin->mobile ?? 'No Number' }}</h5>
                                        </div>
                                        <div class="mt-3">
                                            <p class="mb-1 text-muted">E-mail :</p>
                                            <h5 class="font-size-14">{{ $admin->email ?? 'No E-Mail' }}</h5>
                                        </div>
                                    </div>
                                            ...
                                            <div class="text-center bg-pattern">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <a href="tel:{{ $admin->mobile }}"
                                                        class="btn btn-primary waves-effect waves-light btn-sm"><i
                                                            class="mdi mdi-phone-outline me-1"></i>PhoneCall</a>
                                                    <a href="{{ route('admin.profile.info', $admin->id) }}"
                                                        class="btn btn-primary waves-effect waves-light btn-sm"><i
